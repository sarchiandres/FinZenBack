...
import repository.TipoDocumentoRepository; // Importar el repositorio de TipoDocumento
import repository.TipoUsuarioRepository; // Importar el repositorio de TipoUsuario
